...
export default function RideDetailModal({ visible, ride, onClose }) {
  ...
  const getRideTypeDisplay = () => {
    ...
    return ride.rideType.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase());
  };
  ...
  const handleUpdateRide = async (newStatus, notes) => {
    setIsUpdating(true);
        ...
        <LinearGradient colors={['#0D0D1A', '#1A1A33']} style={styles.container}>
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={onClose} style={styles.closeButton}>
              <Ionicons name="close" size={24} color="#CDB649" />
            </TouchableOpacity>
          </View>
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.infoRow}>
                <Ionicons name="car" size={20} color="#CDB649" />
