...
interface RideUpdateModalProps {
  visible: boolean;
  ride: any;
  onClose: () => void;
...
export default function RideUpdateModal({ visible, ride, onClose, onUpdate }: RideUpdateModalProps) {
              ...
              {RIDE_STATUSES.map((status) => (
                ...
                >
                  ...
                  {selectedStatus === status.value ? (
                    <CheckCircle size={20} color="#CDB649" />
                  ) : (
